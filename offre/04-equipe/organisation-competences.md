# Organisation et Compétences de l'Équipe Projet
...
Son expertise métier garantit que chaque fonctionnalité développée répond précisément aux besoins opérationnels et réglementaires du régime de retraite complémentaire.

**Consultant UX/UI - Spécialiste Accessibilité**
Notre consultant UX/UI apporte 5 années d'expérience dans la conception d'interfaces pour des populations diversifiées, avec une spécialisation en accessibilité numérique. Il garantit que l'interface de Waajal Ëlëk sera intuitive et accessible à tous les militaires, quel que soit leur âge, leur niveau d'éducation ou leurs éventuelles limitations physiques.

**Ingénieur Support - Expert Intégration Systèmes**
Notre ingénieur support spécialisé en intégration système apporte 6 années d'expérience dans la connexion de systèmes hétérogènes, particulièrement dans l'environnement africain où coexistent de multiples technologies. Il est responsable de toutes les intégrations avec les systèmes existants de la Mutuelle et des Forces Armées.

## Méthodologie de Travail Collaborative

### Organisation Agile Scrum Adaptée

Notre équipe fonctionne selon une méthodologie Agile Scrum adaptée aux spécificités du projet Waajal Ëlëk. Cette approche garantit une livraison régulière de fonctionnalités testées et validées, tout en maintenant une capacité d'adaptation aux évolutions des besoins.

L'équipe est organisée en trois squads spécialisées qui travaillent en parallèle : Squad Backend/API (5 personnes), Squad Frontend/Mobile (4 personnes), et Squad Data/IA (3 personnes), plus les experts transversaux (3 personnes) qui interviennent sur tous les aspects du projet.

### Rituels et Communication

Notre organisation s'appuie sur des rituels Agile adaptés : daily standups quotidiens pour la synchronisation, sprint planning collaboratifs, sprint reviews avec démonstrations client, et retrospectives d'amélioration continue. Ces rituels garantissent une communication fluide et une montée en compétence continue de l'équipe.

### Standards de Qualité et Excellence Technique
